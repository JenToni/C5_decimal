...
s21_big_decimal s21_convert_int_to_big(unsigned long int);
s21_decimal s21_convert_int_to_std(unsigned long int);
long int s21_to_integer(s21_decimal);
s21_decimal s21_copy_decimal(s21_decimal);
void s21_init_decimal(s21_decimal *);
s21_decimal s21_left_shift(s21_decimal, int);
int s21_mul_by_ten(s21_decimal, s21_decimal *);
