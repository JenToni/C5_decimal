 ...
 *
 * @param alt1 Первое значение.
 * @param alt2 Второе значение.
 *
 * @return 1, если первое значение больше или равно второму, 0, если второе
 * значение больше первого.
 */
bool s21_compare_bits_big(s21_big_decimal alt1, s21_big_decimal alt2) {
 ...
 *
 * @param alt_value Указатель на значение.
 */
void s21_truncate_big(s21_big_decimal *alt_value) {
  while (alt_value->exp > 0) s21_div_by_ten_big(alt_value);
}
